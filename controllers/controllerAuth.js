...
//demo param: http://localhost:3000/signup?uid=1111111111&name=Vashishth%20Pathak&email=pathakvashishth05@gmail.com&phno=12366666666
const postSignup = (req, res) => {
    ...
    // let Address = query.ema;
    // let Pincode = query.ema;
    ...
    console.log(name, phno); 
            ...
            async function run() {
                ...
                const data = {userId: String(uid), userName: String(name),userEmail: String(email), userPhno: String(phno), isActive: 1, createdAt: Date.now()};
